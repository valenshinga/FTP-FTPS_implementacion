...
def main():
    ...
    authorizer.add_user("user", "12345", "/Users/valen/FTP-FTPS_implementacion/user", perm="elradfmw", msg_login="Conexion exitosa", msg_quit="Te has desconectado")
    ...
    authorizer.add_anonymous("/Users/valen/FTP-FTPS_implementacion/anonimo", msg_login="Conexion exitosa", msg_quit="Te has desconectado")
